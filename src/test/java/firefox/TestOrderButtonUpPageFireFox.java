...
import yandex_practicum_sprint4.HomePage;
    ...
    public class TestOrderButtonUpPageFireFox {
        ...
        public TestOrderButtonUpPageFireFox(String name, String surName, String adress, String metro, String telefon, String data, int period, int color, String coment) {
            this.name = name;
